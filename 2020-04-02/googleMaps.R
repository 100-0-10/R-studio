...
# csv 파일을 가져와서 aprat_data 변수에 할당
...
# 단지명별 평균을 구한 후, mean(as.interger(거래금액) ~ 단지면)
# apart_data_85_cost 변수에 할당

# aggregate() : R 내장함수. 그룹별로 묶어서 연산할 때 사용.
...
# duplicated() : 중복 행 제거 함수 중복된값(TRUE)
#                처음 나오는 값(false)
#                FALSE에 해당하는 값들을 배열로 변환
