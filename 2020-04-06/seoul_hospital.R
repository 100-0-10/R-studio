...
# 서울시 주요 구의 의원 현황을 아래 예시와 각 구별로 나누어서 출력
...
# 동대문구 그래프 그리기
dongdaemoon <- barplot(as.matrix(v7),
                  main = "동대문구 병원현황",
                  beside = T,
                  axes = F,
                  ylab = "병원수(단위:10개)",
...
# 동작구 그래프 그리기
dongjakku <- barplot(as.matrix(v8),
                  main = "동작구 병원현황",
                  beside = T,
                  axes = F,
                  ylab = "병원수(단위:10개)",
...
# 서대문구 그래프 그리기
suedaemoon <- barplot(as.matrix(v10),
                  main = "서대문구 병원현황",
                  beside = T,
                  axes = F,
                  ylab = "병원수(단위:10개)",
